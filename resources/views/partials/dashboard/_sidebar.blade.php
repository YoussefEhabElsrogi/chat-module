        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('brands')
                <li class=" nav-item"><a href="#"><i class="la la-check-square"></i><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        <li class="{{ request()->routeIs('dashboard.brands.index') ? 'active' : '' }}">
            ...
            @can('roles')
                <li class=" nav-item"><a href="#"><i class="la la-unlock-alt"></i><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ request()->routeIs('dashboard.roles.index') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('dashboard.roles.index') }}"
                                data-i18n="">{{ __('dashboard.roles') }}
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @can('admins')
                <li class=" nav-item"><a href="#"><i class="la la-user-secret"></i><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ request()->routeIs('dashboard.admins.index') ? 'active' : '' }}">
            ...
            @can('global_shipping')
                @php
                    $activeRoutes = [
                        ...
                        'dashboard.countries.governorates.index',
                        'dashboard.governorates.cities.index',
                    ];
                @endphp
